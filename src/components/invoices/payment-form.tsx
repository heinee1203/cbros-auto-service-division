        ...
        <div className="space-y-4 mb-6">
          ...
          <div>
            ...
            <input
              ...
              className="w-full rounded-lg border border-surface-300 px-3 py-2 text-sm font-mono focus:border-accent-500 focus:ring-1 focus:ring-accent-500 outline-none"
              placeholder="0.00"
            />
          </div>
